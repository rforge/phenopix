greenExplore <- function(x) {
    ...
    fit.spline.trs <- try(update(fit.spline, 'spline', plot=FALSE))
    ...
    fit.beck.trs <- try(update(fit.beck, 'spline', plot=FALSE))
    ...
    fit.elmore.trs <- try(update(fit.elmore, 'spline', plot=FALSE))
    ...
    fit.klosterman.trs <- try(update(fit.klosterman, 'spline', plot=FALSE))
    ...
    fit.gu.trs <- try(update(fit.gu, 'spline', plot=FALSE))
